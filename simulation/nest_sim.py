...
def main():
    ...
    parser.add_argument('--products', default='simulation/products.csv', help="Path to an products.csv file to load")
    parser.add_argument('--hospitals', default='simulation/hospitals.csv', help="Path to an hospitals.csv file to load")
